...
// (function (){
//
// // We set a delay here so the page can load and give us a chance to put in a value
// before the code runs
//     setTimeout(function(){
// // Because on of our name attributes in the form is 'first' we can retrieve it as a
// property directly
...
// Use hasAttribute('yourAttribute') to make sure before running the next parts
    var star = document.getElementById('review-result');
    console.log(star.hasAttribute('i'));

// get an attribute value
    console.log(star.getAttribute('data-result'));
